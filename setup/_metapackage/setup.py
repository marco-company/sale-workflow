...
setuptools.setup(
    ...
    install_requires=[
        ...
        'odoo-addon-sale_invoice_blocking>=16.0dev,<16.1dev',
        ...
        'odoo-addon-sale_order_line_cancel>=16.0dev,<16.1dev',
        'odoo-addon-sale_order_line_cancel_sale_stock>=16.0dev,<16.1dev',
        'odoo-addon-sale_order_line_date>=16.0dev,<16.1dev',
        'odoo-addon-sale_order_line_delivery_state>=16.0dev,<16.1dev',
        'odoo-addon-sale_order_line_description>=16.0dev,<16.1dev',
        ...
        'odoo-addon-sale_order_line_remove>=16.0dev,<16.1dev',
        ...
        'odoo-addon-sale_order_minimum_amount>=16.0dev,<16.1dev',
        ...
        'odoo-addon-sale_pricelist_display_surcharge>=16.0dev,<16.1dev',
        'odoo-addon-sale_pricelist_from_commitment_date>=16.0dev,<16.1dev',
        'odoo-addon-sale_pricelist_item_advanced>=16.0dev,<16.1dev',
        ...
        'odoo-addon-sale_product_email>=16.0dev,<16.1dev',
        ...
        'odoo-addon-sale_stock_secondary_unit>=16.0dev,<16.1dev',
